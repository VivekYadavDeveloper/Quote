  ...
  void onTapSignOut() async {
    await ref.read(authProvider).signOut().then((_) {
      ...
      if (authProv.authState == AuthState.error) {
        showSnackbar(context, authProv.errorMessage);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        toolbarHeight: 66,
        title: Text("My Profile", style: MyTypography.h3),
      ),
            ...
            Column(
              ...
              children: [
                Text(
                  ...
                  style: GoogleFonts.epilogue(fontSize: 14, color: Colors.grey),
                ),
                const SizedBox(height: 16),
                Row(
                  children: [
                    ...
                    const SizedBox(width: 16),
                    Text('Night mode', style: GoogleFonts.inter(fontSize: 14)),
                    const Spacer(),
                    GFToggle(
                      onChanged: (val) {},
                      value: false,
                ...
                Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 16),
                    Text('Feedback', style: GoogleFonts.inter(fontSize: 14)),
                    const Spacer(),
                    Icon(
                      PhosphorIcons.caretRight(PhosphorIconsStyle.regular),
                      color: Colors.grey,
