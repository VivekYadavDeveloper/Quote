...
class _QuoteDetailPageState extends ConsumerState<QuoteDetailPage> {
  ...
  void onTapFavorite(bool isFavorite, WidgetRef ref) {
    ...
    ref.read(favoriteProvider.notifier).toggleFavorite(quote, isFavorite).then((
      _,
    ) {
  ...
  Future<void> shareQuoteTo(
    ...
    switch (socialShare) {
      case SocialShare.telegram:
        appinioSocialShare.android.shareToTelegram(quot, filePath);
        break;
      case SocialShare.whatsapp:
        appinioSocialShare.android.shareToWhatsapp(quot, filePath);
        break;
      case SocialShare.facebook:
        appinioSocialShare.android.shareToFacebook(
          quot,
          filePath as List<String>,
        );
        break;
      ...
      case SocialShare.messenger:
        appinioSocialShare.android.shareToMessenger(quot);
        break;
      case SocialShare.twitter:
        appinioSocialShare.android.shareToTwitter(quot, filePath);
        break;
      case SocialShare.instagram:
        appinioSocialShare.android.shareToInstagramFeed(quot, filePath!);
        break;
      case SocialShare.instagramDirect:
        appinioSocialShare.android.shareToInstagramDirect(quot);
        break;
      case SocialShare.tiktok:
        appinioSocialShare.android.shareToTiktokStatus(
          filePath! as List<String>,
        );
        break;
      case SocialShare.copyLink:
        appinioSocialShare.android.copyToClipBoard(quot);
        break;
      default:
        appinioSocialShare.android.shareToSystem("Share Quot", quot, filePath);
    }
  }
  ...
  Widget socialShareMenuItem(
    ...
    Widget child = Row(
      children: [
        ...
        Text(title, style: MyTypography.body1.copyWith(color: MyColors.black)),
      ],
    );
      ...
      child = Column(
        children: [
          ...
          Text(
            ...
            maxLines: 2,
            style: MyTypography.body1.copyWith(color: MyColors.black),
          ),
        ],
      );
    }
  ...
  Future<Map<String, Uint8List>?> takeScreenshotQuotWidget() async {
    ...
    final memoryImage = await screenshotController.captureFromWidget(
      cardWidget,
    );
    final memoryImageWithBgPattern = await screenshotController
        .captureFromWidget(cardWidgetWithBgPattern);
  ...
  WoltModalSheetPage shareQuotWidget(BuildContext woltContext) {
    return WoltModalSheetPage(
      topBarTitle: Text("Share Quot Widget", style: MyTypography.h3),
              ...
              child: Row(
                children: [
                  socialShareMenuItem(
                    ...
                    PhosphorIcons.telegramLogo(PhosphorIconsStyle.regular),
                    Colors.blue,
                    "Telegram",
                    isHorizontal: true,
                    memoryImage: memoryImage.values
                        .toList()[indexViewNotifier.value],
                  ),
                  socialShareMenuItem(
                    context,
                  ...
                  socialShareMenuItem(
                    context,
                    SocialShare.twitter,
                    PhosphorIcons.twitterLogo(PhosphorIconsStyle.regular),
                    Colors.blue,
                    "Twitter",
                    isHorizontal: true,
                    memoryImage: memoryImage.values
                  ...
                  socialShareMenuItem(
                    context,
                    SocialShare.tiktok,
                    PhosphorIcons.tiktokLogo(PhosphorIconsStyle.regular),
                    Colors.black,
                    "Tiktok",
                    isHorizontal: true,
                    memoryImage: memoryImage.values
  ...
  WoltModalSheetPage shareQuot(BuildContext woltContext) {
    return WoltModalSheetPage(
      topBarTitle: Text("Share Quot", style: MyTypography.h3),
      isTopBarLayerAlwaysVisible: true,
      leadingNavBarWidget: Padding(
        padding: const EdgeInsets.only(left: 10),
        child: IconSolidLight(
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    Icon(
                      PhosphorIcons.cards(PhosphorIconsStyle.regular),
                      color: MyColors.black,
                    ),
                    const SizedBox(width: 20),
                    Text(
        ...
        child: Stack(
          children: [
            Positioned(
              left: 168,
              top: -70,
              child: Image.asset("assets/img_bg_pattern.png", width: 254),
            ),
            Padding(
